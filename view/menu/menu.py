...
decay_adjust_path = [
    constant.adjust_operation_path,
    constant.decay_adjust_path,
]
...
standby_raider_path = [
    constant.raider_operation_path, constant.standby_raider_path,
    constant.raider_path
]
...
all_paths = [
    reward_adjust_path, manual_adjust_path, loot_adjust_path,
    decay_adjust_path, loot_announce_path, standby_raider_path, system_path
]
